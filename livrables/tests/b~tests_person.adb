pragma Ada_95;
pragma Warnings (Off);
pragma Source_File_Name (ada_main, Spec_File_Name => "b~tests_person.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~tests_person.adb");
...
package body ada_main is
   ...
   E117 : Short_Integer; pragma Import (Ada, E117, "person_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_tests_person");
